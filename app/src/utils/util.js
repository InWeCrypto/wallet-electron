...
export const getMainMinHeight = () => {
    let header = parseInt(document.getElementById("headerBox").offsetHeight, 10);
    let footer = document.getElementById("footerBox") && parseInt(document.getElementById("footerBox").offsetHeight, 10);
...
export const formatTimeToChina = t => {
    ...
    if (space > 60 * 60 * 24 * 30) 
        return "一个月以前";
    if (space > 60 * 60 * 24 * 15) 
        return "十五天以前";
    if (space > 60 * 60 * 24 * 7) 
        return "一周以前";
...
export const chargeFooterFixed = () => {
    ...
    document
        ...
        .style
        .minHeight = screenHei - footerHei - headerHei + "px";
    // } else { 	return false; }
};
